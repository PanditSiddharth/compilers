    ...
    try {
        ...
        const commands = {
            ...
            "jv": ["run", "-i", "--rm", "openjdk:25-slim", "sh", "-c",
                `echo "${(_b = newObj === null || newObj === void 0 ? void 0 : newObj.code) === null || _b === void 0 ? void 0 : _b.replace(/"/g, '\\"')}" > ${(0, tools_1.findClass)(newObj.code)}.java && javac ${newObj.code}.java && java ${(0, tools_1.findClass)(newObj.code)}`
            ],
        ...
        (_f = newObj.node) === null || _f === void 0 ? void 0 : _f.setMaxListeners(0);
