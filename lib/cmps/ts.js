...
let tsxpath = path_1.default.join('.', 'node_modules', '.bin', 'tsx');
let nodepath = path_1.default.dirname(jsexe);
...
let jsyoyojs = async (ctx, obj = {}) => {
    ...
    try {
        ...
        newObj.node = (0, child_process_1.spawn)(tsxpath, ['-e', newObj.code], config_1.default.spawnOptions ? config_1.default.spawnOptions : { env: {
                PATH: nodepath
            } });
